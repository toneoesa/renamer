...
int main(int argc, char *argv[])
{
	...
	p.add<int>("lower", '\0', "change the [basename(1), extension(2), both(3)] to lower case", false, 3, cmdline::oneof<int>(1, 2, 3));
	p.add<int>("upper", '\0', "change the [basename(1), extension(2), both(3)] to upper case", false, 3, cmdline::oneof<int>(1, 2, 3));
